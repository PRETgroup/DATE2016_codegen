...
(Q0)  {$v^\prime_x = v_x + \delta a^0_x v_x$ \\ $v^\prime_y = v_y + \delta a^0_y v_y$ \\ $v^\prime_z = v_z + \delta a^0_z v_z$ \\ $v^\prime=v^\prime_x - v^\prime_y + v^\prime_z$};
...
(Q1) [node distance=6.3cm, right of=Q0] {\small{ $v^\prime_x {=} v_x {+} \delta (a^1_x v_x {+} \beta_x g(\vec{v}))$ \\ $v^\prime_y {=} v_y {+} \delta (a^1_y v_y {+} \beta_x g(\vec{v}))$ \\ $v^\prime_z {=} v_z {+} \delta (a^1_z v_z {+} \beta_x g(\vec{v}))$ \\ $v^\prime=v^\prime_x - v^\prime_y + v^\prime_z$}};

\node[state, 
label={[shift={(0,-2.5)}]$v \leq V_O - 80.1 \sqrt{\theta}$}, 
label={[shift={(-1.5,0)}]\large $\mathbf{q_2}$  }] 
(Q2) [below of=Q1] {$v^\prime_x = v_x + \delta a^2_x v_x$ \\ $v^\prime_y = v_y + \delta a^2_y v_y$ \\ $v^\prime_z = v_z + \delta a^2_z v_z$ \\ $v^\prime=v^\prime_x - v^\prime_y + v^\prime_z$};

\node[state, 
label={[shift={(0,-2.5)}]$v \geq V_R$}, 
label={[shift={(-1.5,0)}]\large $\mathbf{q_3}$  }]
(Q3) [below of=Q0] {$v^\prime_x = v_x + \delta a^3_x v_x f(\theta)$ \\ $v^\prime_y = v_y + \delta a^3_y v_y f(\theta)$ \\ $v^\prime_z = v_z + \delta a^3_z v_z$ \\ $v^\prime=v^\prime_x - v^\prime_y + v^\prime_z$};
