...
\tikzstyle{every state}=[rectangle,rounded corners,
 minimum height = 1.2cm, text width=3cm, text centered, fill=blue!20,draw=none,text=black, draw,line width=0.3mm]
...
(Q1) [node distance=6cm, right of=Q0] {$\dot{v_x}=a^1_x v_x + \beta_x g(\vec{v})$ \\ $\dot{v_y}=a^1_y v_y + \beta_y g(\vec{v})$ \\ $\dot{v_z}=a^1_z v_z + \beta_z g(\vec{v})$ \\ $v=v_x - v_y + v_z$};
