...
\node[state, shift={(0.55, -1.5)}, fill=green!20, minimum width=1.1cm] {Rest};
\node[state, shift={(1.35, -1.5)}, fill=blue!20, minimum width=0.5cm] {};
...
\node[state, shift={(6.40, -1.5)}, fill=green!20, minimum width=1cm] {Rest};
