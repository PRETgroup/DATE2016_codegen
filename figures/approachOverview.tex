...
\node[below of = HA1, node distance = 1.0cm](PAR){\Large $\dots$};
\node [fileS,fill=red!10,below of = PAR, node distance = 1.0cm] (HA2) 
...
\node[below of = FSM1, node distance = 1.0cm](PAR){\Large $\dots$};
\node [fileS,,fill=red!20,below of = PAR, text width=4.6em, node distance = 1.0cm] (FSM2) 
