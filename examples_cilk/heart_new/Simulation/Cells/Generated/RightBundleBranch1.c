...
void RightBundleBranch1Init(RightBundleBranch1* me) {
    ...
    me->g = 0;
	#if 32 > 0
	me->pacing_rate = 1 / ((32 / 60.0) * STEP_SIZE);
	#else
	me->pacing_rate = 0;
	#endif
