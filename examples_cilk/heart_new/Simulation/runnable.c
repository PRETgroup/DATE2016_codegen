...
int main(void) {
  ...
  for(i=0; i < (SIMULATION_TIME / STEP_SIZE); i++) {
    ...
    cilk_spawn SinoatrialNodeRun(&SinoatrialNode_data,
				 ...
				 &RightAtrium1_data,
				 &CoronarySinus_data,
				 &CristaTerminalis_data,
				 &CristaTerminalis1_data,
				 &Ostium_data,
				 &Fast_data,
				 &Fast1_data,
				 &Slow_data,
				 &Slow1_data,
				 &AtrioventricularNode_data,
				 &BundleOfHis_data,
				 &BundleOfHis1_data,
				 &BundleOfHis2_data,
				 &LeftBundleBranch_data,
				 &LeftBundleBranch1_data,
				 &LeftVentricularApex_data,
				 &LeftVentricle_data,
				 &LeftVentricle1_data,
				 &LeftVentricularSeptum_data,
				 &LeftVentricularSeptum1_data,
				 &CSLeftVentricular_data,
				 &RightBundleBranch_data,
				 &RightBundleBranch1_data,
				 &RightVentricularApex_data,
				 &RightVentricle_data,
				 &RightVentricle1_data,
				 &RightVentricularSeptum_data,
				 &RightVentricularSeptum1_data
				 );
