...
void LBB1_LVAInit(LBB1_LVA* me) {
	...
	me->cell1_v_buffer = malloc(sizeof(double) * LBB1_LVA_CELL1_NUM_ITEMS);
	me->cell1_mode_buffer = malloc(sizeof(unsigned char) * LBB1_LVA_CELL1_NUM_ITEMS);
	
	int i=0;
    for(i=0; i<LBB1_LVA_CELL1_NUM_ITEMS; i++) {
        me->cell1_v_buffer[i] = 0;
        me->cell1_mode_buffer[i] = 0;
    }
    me->cell1_buffer_index = 0;
	
	me->cell2_v_buffer = malloc(sizeof(double) * LBB1_LVA_CELL2_NUM_ITEMS);
	me->cell2_mode_buffer = malloc(sizeof(unsigned char) * LBB1_LVA_CELL2_NUM_ITEMS);

    for(i=0; i<LBB1_LVA_CELL2_NUM_ITEMS; i++) {
...
void LBB1_LVARun(LBB1_LVA* me) {
    ...
    if(me->cell1_buffer_index >= LBB1_LVA_CELL1_NUM_ITEMS)
        me->cell1_buffer_index = 0;
    ...
    if(me->cell2_buffer_index >= LBB1_LVA_CELL2_NUM_ITEMS)
        me->cell2_buffer_index = 0;
