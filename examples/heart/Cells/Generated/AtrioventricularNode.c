...
void AtrioventricularNodeRun(AtrioventricularNode* me) {
    ...
    me->g = 0;
    me->g += (100 * 0.1 * (me->v_i_0 - me->v)) / (100 * 0.01 * 8);
    me->g += (100 * 0.1 * (me->v_i_1 - me->v)) / (100 * 0.01 * 8);
