...
void PathInit(Path* me) {
    ...
    for(int i=0; i<(cell1_conduction_time / STEP_SIZE); i++) {
        me->cell1_v_buffer[i] = 0;
        me->cell1_mode_buffer[i] = 0;
    }
    me->cell1_buffer_index = 0;

    for(int i=0; i<(cell2_conduction_time / STEP_SIZE); i++) {
...
void PathRun(Path* me) {
    ...
    if(me->cell1_buffer_index >= cell1_conduction_time / STEP_SIZE)
        me->cell1_buffer_index = 0;
    ...
    if(me->cell2_buffer_index >= cell2_conduction_time / STEP_SIZE)
        me->cell2_buffer_index = 0;
