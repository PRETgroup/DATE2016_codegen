...
typedef struct {
	...
	double cell1_v_buffer[(int) (cell1_conduction_time / STEP_SIZE)];
	unsigned char cell1_mode_buffer[(int) (cell1_conduction_time / STEP_SIZE)];
	unsigned int cell1_buffer_index;

	double cell2_v_buffer[(int) (cell2_conduction_time / STEP_SIZE)];
	unsigned char cell2_mode_buffer[(int) (cell2_conduction_time / STEP_SIZE)];
