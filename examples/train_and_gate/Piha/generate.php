...
if(is_file("Trains/trains.csv")) {
	...
	foreach($data as $train) {
		...
		if(is_file("Trains/Train.c") && is_file("Trains/Train.h")) {
			...
			fwrite($makefile, "\t@cl /c /O" . $opt_level . " Trains/Generated/" . $safe_name . ".c /Fo" . $dir . "\\Objects\\" . $safe_name . "\n");
			fwrite($makefile, "\n");
		}
		else {
...
if(is_file("Gates/gates.csv")) {
	...
	foreach($data as $gate) {
		...
		if(is_file("Gates/Gate.c") && is_file("Gates/Gate.h")) {
			...
			fwrite($makefile, "\t@cl /c /O" . $opt_level . " Gates/Generated/" . $safe_name . ".c /Fo" . $dir . "\\Objects\\" . $safe_name . "\n");
			fwrite($makefile, "\n");
		}
		else {
