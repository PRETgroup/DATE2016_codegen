...
void His1_His2Init(His1_His2* me) {
	...
	me->cell1_v_buffer = malloc(sizeof(double) * His1_His2_CELL1_NUM_ITEMS);
	me->cell1_mode_buffer = malloc(sizeof(unsigned char) * His1_His2_CELL1_NUM_ITEMS);
	
	int i=0;
    for(i=0; i<His1_His2_CELL1_NUM_ITEMS; i++) {
        me->cell1_v_buffer[i] = 0;
        me->cell1_mode_buffer[i] = 0;
    }
    me->cell1_buffer_index = 0;
	
	me->cell2_v_buffer = malloc(sizeof(double) * His1_His2_CELL2_NUM_ITEMS);
	me->cell2_mode_buffer = malloc(sizeof(unsigned char) * His1_His2_CELL2_NUM_ITEMS);

    for(i=0; i<His1_His2_CELL2_NUM_ITEMS; i++) {
...
void His1_His2Run(His1_His2* me) {
    ...
    if(me->cell1_buffer_index >= His1_His2_CELL1_NUM_ITEMS)
        me->cell1_buffer_index = 0;
    ...
    if(me->cell2_buffer_index >= His1_His2_CELL2_NUM_ITEMS)
        me->cell2_buffer_index = 0;
