...
void RV_RV1Init(RV_RV1* me) {
	...
	me->cell1_v_buffer = malloc(sizeof(double) * RV_RV1_CELL1_NUM_ITEMS);
	me->cell1_mode_buffer = malloc(sizeof(unsigned char) * RV_RV1_CELL1_NUM_ITEMS);
	
	int i=0;
    for(i=0; i<RV_RV1_CELL1_NUM_ITEMS; i++) {
        me->cell1_v_buffer[i] = 0;
        me->cell1_mode_buffer[i] = 0;
    }
    me->cell1_buffer_index = 0;
	
	me->cell2_v_buffer = malloc(sizeof(double) * RV_RV1_CELL2_NUM_ITEMS);
	me->cell2_mode_buffer = malloc(sizeof(unsigned char) * RV_RV1_CELL2_NUM_ITEMS);

    for(i=0; i<RV_RV1_CELL2_NUM_ITEMS; i++) {
...
void RV_RV1Run(RV_RV1* me) {
    ...
    if(me->cell1_buffer_index >= RV_RV1_CELL1_NUM_ITEMS)
        me->cell1_buffer_index = 0;
    ...
    if(me->cell2_buffer_index >= RV_RV1_CELL2_NUM_ITEMS)
        me->cell2_buffer_index = 0;
