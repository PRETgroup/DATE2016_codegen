...
is depicted as the \acf{AP}~\cite{chen14}, which is shown in
Figure~\ref{fig:actionPotential}. The \ac{AP} can be described in four
stages.
\begin{enumerate}
...
described using \acf{HIOA} in Section~\ref{sec:HA}. {\color{red}
  [AVINASH: The path model is not presented anywhere in the paper]]The
  path model describes the conduction delay of the electrical
  signal. }Later in Section~\ref{sec:codeGen}, we use this network of
nodes to illustrate our modular code generation.
