\begin{abstract}
  ...
  considered a maximum of 33~nodes~\footnote{Authors express their
  	 gratitude to the research 
  	group of Prof. Marta Kwiatkowska for sharing their \simulink
  	heart model reported in~\cite{chen14}, 
  	which was foundational in developing the
  	 proposed models in this paper}, modelled as \acf{HIOA}. The
  ...
  faster when compared to \simulink. \ignore{ We have also compared the
