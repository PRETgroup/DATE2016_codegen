...
variables ($v_x$, $v_y$, and $v_z$) and is based on existing model~\cite{YeESG08}. 
...
$Init(l): v_{x}=0 \wedge v_{y}=0 \wedge v_{z}=0 \wedge \theta=0$. An example 
edge connecting locations $q_{0}$ and $q_{1}$ is represented with the tuple:
