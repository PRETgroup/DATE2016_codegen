...
C_{1}v_{x}$}, capture the continuous evolution of the voltage of the node in 
location $\mathbf{q_{0}}$ until the so called location invariant
$v < V_{T}$ holds.  Once the external
