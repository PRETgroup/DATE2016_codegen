...
describe  input, output and internal signals. Further,
...
\begin{definition}[Deterministic Hybrid Automata]
	\label{def:dha}
	An hybrid automata is called \acf{DHA} if 
	for all locations, there does not exist one 
	active 
